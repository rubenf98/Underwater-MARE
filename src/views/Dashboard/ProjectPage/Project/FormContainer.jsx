...
import { Checkbox, Col, DatePicker, Form, Input, InputNumber, Modal, Row, Select, Space } from 'antd'
        ...
        >
            ...
            <Form initialValues={{ public: true }} style={{ margin: "30px auto" }} layout="vertical" requiredMark form={form}>
                <Row gutter={16}>
                    ...
                    <Col span={24}>
                        <Form.Item label="Geographic area (as per the United Nations geoscheme)" name="geographic_area" rules={requiredRule}>
                            <Select placeholder="As per the United Nations geoscheme" options={[
                    ...
                    <Col span={24}>
                        <Form.Item label="Community contributing to the data collection" name="community_size" rules={requiredRule}>
                            <Select options={[
                                { value: "<10", label: "<10" },
                    ...
                    <Col span={12}>
                        <Form.Item label="Period of data colections" name="start_period">
                            <DatePicker picker="year" placeholder='Start date' style={{ width: "100%" }} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="  " name="end_period">
                            <DatePicker picker="year" placeholder='End date' style={{ width: "100%" }} />
                        </Form.Item>
                    </Col>
