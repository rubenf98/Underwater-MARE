...
import { Button, Checkbox, Col, Form, Input, InputNumber, Modal, Row, Select, Space } from 'antd'
                ...
                <Row gutter={16}>
                    ...
                    <Col span={24}>
                        ...
                        <Checkbox.Group
                            ...
                            onChange={(e) => { setSelectedIndicatorList(e) }}
                            value={selectedIndicatorList}
                        />
                    </Col>
                    <Col span={24}>
                        {selectedIndicatorList.length ? <p>Indicator(s) value(s)</p> : <></>}
